  ...
  return (
    <>
      ...
      <Routes>
        ...
        <Route
          path="/all-companies"
          element={<MyAllCompanies token={token} />}
        />
        <Route path="/:companyId" element={<SingleCompany token={token} />} />
        <Route
          path="/:companyId/catalog-details/:catalogId"
          element={<MyCatalogDetails token={token} />}
        />
        <Route
          path="/:companyId/service-details/:servId"
          element={<MyServiceDetails token={token} />}
        />
        <Route
          path="/:companyName/request-quote"
          element={<SingleCompanyQuote token={token} />}
        />

        <Route
          path="/one-click-quotation"
          element={<OneClickQuotation token={token} />}
        />

        <Route
          path="/all-insights"
          element={<MyCompaniesInsights token={token} />}
        />
        ...
        <Route
          path="/all-Industries/:subIndustryID"
          element={<SubCategoryMain />}
        />
        ...
        <Route
          path="/login"
          element={<MyLogin type={loginType} setType={setLoginType} />}
        />
        <Route path="/forget-password" element={<EnterUrEmail />} />
        <Route path="/reset-password" element={<ResetPassword />} />
        <Route
          path="/user-verification"
          element={<UserVirificationSec token={token} />}
        />

        {/* Profile Routes */}
        <Route
          path="/profile/followers"
          element={<CompanyFollowers loginType={loginType} token={token} />}
        />

        <Route
          path="/profile/packages-settings"
          element={<MyPackagesSettings token={token} />}
        />
        ...
        <Route
          path="/profile/catalog/addNewItem"
          element={<NewCatalogItemForm token={token} />}
        />
        <Route
          path="/profile/catalog/edit-item/:id"
          element={<NewCatalogItemForm token={token} />}
        />
        <Route
          path="/profile/catalog/edit-item/:id/edit-option"
          element={<CatalogOptionForm currPage={"catalog"} token={token} />}
        />

        <Route
          path="/profile/catalogs/show-one/:itemId"
          element={
            <ShowOneProductInfoInDash
              token={token}
        ...
        <Route
          path="/profile/network/addNewItem"
          element={<NewNetworkForm token={token} />}
        />
        <Route
          path="/profile/network/edit-item/:id"
          element={<NewNetworkForm token={token} />}
        />

        <Route
          path="/profile/previous-work"
          element={<PrevWork token={token} />}
        />
        <Route
          path="/profile/previous-work/addNewItem"
          element={<AddNewPrevWork token={token} />}
        />
        <Route
          path="/profile/previous-work/edit-item/:id"
          element={<AddNewPrevWork token={token} />}
        />

        <Route path="/profile/service" element={<MyService token={token} />} />
        <Route
          path="/profile/service/addNewItem"
          element={<NewServiceForm token={token} />}
        />
        <Route
          path="/profile/service/edit-item/:id"
          element={<NewServiceForm token={token} />}
        />
        <Route
          path="/profile/service/show-one/:itemId"
          element={
            <ShowOneProductInfoInDash
              token={token}
        ...
        />
        <Route
          path="/profile/service/edit-item/:id/edit-option"
          element={<CatalogOptionForm currPage={"service"} token={token} />}
        />

        <Route path="/profile/media" element={<MyMedia token={token} />} />
        <Route
          path="/profile/media/addNewItem"
          element={<NewMediaForm token={token} />}
        />
        <Route
          path="/profile/media/edit-item/:id"
          element={<NewMediaForm token={token} />}
        />

        <Route
          path="/profile/appointments"
          element={<MyAppointements token={token} />}
        />
        <Route
          path="/profile/appointments/addNewAppointment"
          element={<NewAppointementFrom token={token} />}
        />

        <Route
          path="/profile/booked-appointments"
          element={<MyBookedAppointements token={token} />}
        />

        <Route
          path="/profile/contact-form"
          element={<MyComanyForm token={token} />}
        />
        <Route
          path="/profile/products"
          element={<MyProducts token={token} />}
        />
        <Route
          path="/profile/products/addNewItem"
          element={<NewProductForm token={token} />}
        />
        ...
        <Route
          path="/profile/products/show-one/:itemId"
          element={<ShowOneECommProductInDash token={token} />}
        />

        <Route path="/profile/faqs" element={<MyFaqs token={token} />} />
        <Route
          path="/profile/faqs/addNewItem"
          element={<NewFaqForm token={token} />}
        />
        <Route
          path="/profile/faqs/edit-item/:id"
          element={<NewFaqForm token={token} />}
        />

        <Route path="/profile/posts" element={<MyPosts token={token} />} />
        <Route
          path="/profile/posts/addNewItem"
          element={<NewPostForm token={token} />}
        />
        <Route
          path="/profile/posts/edit-item/:id"
          element={<NewPostForm token={token} />}
        />
        ...
        <Route
          ...
          element={<MyQutations token={token} />}
        />
        <Route
          path="/profile/quotations/:quotationsId"
          element={<ShowSingleQuotation token={token} />}
        />

        <Route
          path="/profile/oneclick-quotations"
          element={<OneClickQuotationsDashboard token={token} />}
        />
        <Route
          path="/profile/companyoneclick-quotations/:quotationsId"
          element={<ShowSingleQuotation token={token} />}
        />
        <Route
          path="/profile/oneclick-quotations/:negotiateId"
          element={<OneClickNegotiationCompanies token={token} />}
        />
        <Route
          path="/profile/oneclick-quotations/:negotiateId/:offerId"
          element={<ShowOneClickQuotation token={token} />}
        />

        <Route
          path="/profile/quotation-orders"
          element={<MyOrders token={token} />}
        />
        <Route
          path="/profile/quotation-orders/:orderId"
          element={<ShowOneOrderInfo token={token} />}
        />
        ...
        />
        <Route
          path="/your-messages/:activeChatId"
          element={
            <MyMessage
              setFireMessage={setFireMessage}
              fireMessage={fireMessage}
        ...
        <Route
          ...
          element={<MyProfileSettings token={token} />}
        />
        <Route
          path="/profile/business-settings"
          element={<MyBussinessSettings token={token} />}
        />
        <Route
          path="/profile/users-management"
          element={<MyUsersManagement token={token} />}
        />
      </Routes>

      {!(
        location.pathname.includes("profile") ||
        location.pathname.includes("your-messages")
      ) && <MyFooter />}
    </>
  );
}
