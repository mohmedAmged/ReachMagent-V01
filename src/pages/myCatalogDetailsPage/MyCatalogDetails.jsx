...
export default function MyCatalogDetails({ token }) {
    ...
    useEffect(() => {
        if (currentCatalog?.media) {
            setCurrImg(currentCatalog?.media[0]?.image ? currentCatalog?.media[0]?.image : '');
    ...
    const getCurrentCatalog = async () => {
        setLoading(true);
        await axios.get(`${baseURL}/show-catalog/${catalogId}?t=${new Date().getTime()}`, {
            headers: {
                                                ...
                                                <div className="col-lg-6 mb-3">
                                                    <p className='fw-medium text-capitalize fs-4'>
                                                        ...
                                                        <span className='fw-medium ms-2 fs-5'>
                                                            {currentCatalog?.price} {currentCatalog?.currency}
                                                        </span>
                                                    </p>
                                                </div>
                                                <div className="col-lg-6 mb-3">
                                                    <p className='fw-medium text-capitalize fs-4'>
                                                        tax:
                                                        <span className='fw-medium ms-2 fs-5'>
                                                            {currentCatalog?.tax} {currentCatalog?.currency}
                                                        </span>
                                                    </p>
                                                </div>
                                                <div className="col-lg-6 mb-3">
                                                ...
                                                <div className="col-lg-12 mb-3">
                                                    <p className='fw-medium text-capitalize fs-4'>
                                                        ...
                                                        <span className='fw-medium limitedP ms-2 fs-5'>
                                                            {currentCatalog?.unit_of_measure}
                                                        </span>
                                                    </p>
                                                </div>
                                            </div>
                                                ...
                                                currentCatalog?.catalogTypes?.map((prod, index) => (
                                                    <div className="col-lg-12" key={index}>
                                                        <p className='fw-bold fs-5 text-capitalize'>
                                                            type ({index + 1}):
                                                            <span className='fw-medium ms-3 fs-6'> {prod?.type ? prod?.type : ''}</span>
                                                        </p>
                                                    </div>
                                                ))
                                            }
